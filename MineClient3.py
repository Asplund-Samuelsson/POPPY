...
# Adapted for Python 3.5.1 by Johannes Asplund-Samuelsson
...
import urllib.parse as _urlparse # Edited /JAS
import random as _random
import base64 as _base64
from configparser import ConfigParser as _ConfigParser # Edited /JAS
import os as _os
...
def _read_rcfile(file=_os.environ['HOME'] + '/.authrc'):  # @ReservedAssignment
    ...
    if _os.path.exists(file):
        ...
        except Exception as e: # Edited /JAS
            print("Error while reading authrc file %s: %s" % (file, e)) # Edited /JAS
    return authdata
...
def _read_inifile(file=_os.environ.get(  # @ReservedAssignment
    ...
    if _os.path.exists(file):
        try:
            ...
            print("Error while reading INI file %s: %s" % (file, e)) # Edited /JAS
    return authdata
